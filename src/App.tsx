...
const projects: Project[] = [
  {
    ...
    tech: ["JavaScript", "Browser APIs", "HTML5 Video APIs", "YouTube Integration", "Extension APIs"],
  ...
  },
  {
    ...
    description: "Scalable Telegram bot for leveling, moderation, and onboarding.",
...
const skillCards: SkillCard[] = [
  { title: "Languages", lines: ["JavaScript", "TypeScript", "Java", "Python"] },
  { title: "Frontend", lines: ["React.js", "Vite", "HTML", "CSS"] },
  { title: "Backend", lines: ["Node.js", "Express.js", "REST API Development"] },
  { title: "Mobile & Desktop", lines: ["React Native", "Expo", "Tauri"] },
  { title: "Databases & Services", lines: ["PostgreSQL", "Supabase", "Firebase"] },
  { title: "Engineering", lines: ["Browser Extensions", "Telegram Bots", "API Integration", "Git & GitHub"] }
];
...
const additionalProjects: MiniProject[] = [
  ...
  {
    title: "Manga World",
    description: "Mobile manga reader aggregating content from multiple online sources through API integration.",
    tech: "React Native, APIs"
  },
  {
    title: "Music Share",
    description: "Spotify-connected mobile app for personal liked-song workflows and offline-oriented listening access.",
    tech: "React Native, Spotify API"
  },
  {
    title: "Umbrella Dictionary Bot",
    description: "Telegram dictionary bot that returns word definitions and usage examples via API-powered responses.",
    tech: "Node.js, APIs"
  }
];
...
function HashTitle({ text, line = true }: { text: string; line?: boolean }) {
  return (
    <div className="hash-title">
      ...
      {line ? <div className="title-line" aria-hidden /> : null}
    </div>
  );
}
  ...
  return (
    <div className="site" id="home">
      <aside className="social-rail" aria-label="social links">
        ...
        <a href="https://github.com/IBO-Umbrel" target="_blank" rel="noreferrer" aria-label="GitHub">
          <img src={githubIcon} alt="" aria-hidden />
        </a>
        <a href="https://t.me/ibo_umbrella" target="_blank" rel="noreferrer" aria-label="Telegram">
          <img src={telegramIcon} alt="" aria-hidden />
        </a>
        <a href="https://discord.com/users/nonameraid" target="_blank" rel="noreferrer" aria-label="Discord">
          <img src={discordIcon} alt="" aria-hidden />
        </a>
      </aside>
      ...
      <main className="container">
        <section className="hero-section">
          <div className="hero-copy">
            ...
            <p>
              ...
              focus on modern JavaScript architecture.
            </p>
        ...
        <section id="works" className="projects-section">
          <div className="section-head">
            ...
            <a href="#works" className="view-link">
              Featured work
            </a>
          </div>
              ...
              <article key={project.title} className="project-card">
                ...
                <div className="project-content">
                  ...
                  <div className="project-links">
                    ...
                    {project.cached ? (
                      <a href={project.cached} className="btn btn-secondary">
                        Cached &gt;=
                      </a>
                    ) : null}
                  </div>
        ...
        <section id="additional-projects" className="skills-section">
          <div className="section-head">
        ...
        <section id="skills" className="skills-section">
          <HashTitle text="skills" line={false} />
          <div className="skills-layout">
            <div className="decor-grid" aria-hidden>
        ...
        <section id="about" className="about-section">
          ...
          <div className="about-layout">
            <div>
              ...
              <p>
                My engineering focus includes backend API architecture, performance optimization, browser extension
                development, Telegram bot systems, cross-platform mobile delivery, and rapid independent execution.
              </p>
              <a
        ...
        <section id="contacts" className="contacts-section">
          ...
          <div className="contacts-layout">
            <p>
              I&apos;m open to product-focused opportunities in Full-Stack, Backend, React, and React Native roles.
              Let&apos;s build something scalable and useful.
            </p>
            <div className="message-box">
              <h3>Message me here</h3>
              <a href="tel:+998951309955">+998 95 130 99 55</a>
              <a href="mailto:ibo.umbrella@gmail.com">ibo.umbrella@gmail.com</a>
              <a href="https://t.me/ibo_umbrella" target="_blank" rel="noreferrer">
                t.me/ibo_umbrella
              </a>
              <a href="https://github.com/IBO-Umbrel" target="_blank" rel="noreferrer">
                github.com/IBO-Umbrel
              </a>
              <a href="https://discord.com/users/nonameraid" target="_blank" rel="noreferrer">
